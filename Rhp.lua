...
ControllerAll = false
local ListSudos ={Sudo_Id,5271603990}  
...
Status = Redis:get(FDFGERB.."FDFGERB:Developer:Bot:Reply"..ChatId) or 'Dev'
elseif TheBasicsQ then
Status = Redis:get(FDFGERB.."FDFGERB:PresidentQ:Group:Reply"..ChatId) or 'المالك'
...
local msg_id = msg.id
if data.sender.luatele == "messageSenderChat" and Redis:get(FDFGERB.."Lock:channell"..msg_chat_id) then
print("channel")
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end
Redis:incr(FDFGERB..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) 
...
elseif tonumber(msg.sender.user_id) == 5271603990 then
...
msg.Name_Controller = Redis:get(FDFGERB.."FDFGERB:Developer:Bot:Reply"..msg.chat_id) or 'Dev '
elseif Redis:sismember(FDFGERB.."FDFGERB:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(FDFGERB.."FDFGERB:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
...
if Redis:get(FDFGERB.."FDFGERB:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n°  تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(FDFGERB.."FDFGERB:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(FDFGERB.."FDFGERB:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(FDFGERB.."FDFGERB:Set:Id:Groups"..msg.chat_id,text:match("(.*)"))
...
if Redis:get(FDFGERB.."FDFGERB:Game:Ghj"..msg.chat_id) then
if text == Redis:get(FDFGERB.."FDFGERB:Game:Ghj"..msg.chat_id) then
Redis:del(FDFGERB.."FDFGERB:Game:Ghj"..msg.chat_id)
Redis:incrby(FDFGERB.."FDFGERB:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n*° كفو اجابتك صح *","md",true)  

end
end 
if Redis:get(FDFGERB.."FDFGERB:Game:Amt"..msg.chat_id) then
if text == Redis:get(FDFGERB.."FDFGERB:Game:Amt"..msg.chat_id) then
Redis:del(FDFGERB.."FDFGERB:Game:Amt"..msg.chat_id)
Redis:incrby(FDFGERB.."FDFGERB:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n*° كفو اجابتك صح *","md",true)  

end
end 
if Redis:get(FDFGERB.."FDFGERB:Game:Aii"..msg.chat_id) then
if text == Redis:get(FDFGERB.."FDFGERB:Game:Aii"..msg.chat_id) then
Redis:del(FDFGERB.."FDFGERB:Game:Aii"..msg.chat_id)
Redis:incrby(FDFGERB.."FDFGERB:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n*° كفو اجابتك صح *","md",true)  

end
end 
if Redis:get(FDFGERB.."FDFGERB:Game:Aig"..msg.chat_id) then
if text == Redis:get(FDFGERB.."FDFGERB:Game:Aig"..msg.chat_id) then
Redis:del(FDFGERB.."FDFGERB:Game:Aig"..msg.chat_id)
Redis:incrby(FDFGERB.."FDFGERB:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n*° كفو اجابتك صح *","md",true)  

end
end 
if Redis:get(FDFGERB.."FDFGERB:Game:Ret"..msg.chat_id) then
if text == Redis:get(FDFGERB.."FDFGERB:Game:Ret"..msg.chat_id) then
Redis:del(FDFGERB.."FDFGERB:Game:Ret"..msg.chat_id)
Redis:incrby(FDFGERB.."FDFGERB:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n*° كفو اجابتك صح *","md",true)  

end
end 
if Redis:get(FDFGERB.."FDFGERB:Game:Gii"..msg.chat_id) then
if text == Redis:get(FDFGERB.."FDFGERB:Game:Gii"..msg.chat_id) then
Redis:del(FDFGERB.."FDFGERB:Game:Gii"..msg.chat_id)
Redis:incrby(FDFGERB.."FDFGERB:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n*° كفو اجابتك صح *","md",true)  
...
if Redis:get(FDFGERB.."FDFGERB:Game:Arg"..msg.chat_id) then
if text == Redis:get(FDFGERB.."FDFGERB:Game:Arg"..msg.chat_id) then
Redis:incrby(FDFGERB.."FDFGERB:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(FDFGERB.."FDFGERB:Game:Arg"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n*° كفو اجابتك صح *","md",true)  

end
end

if Redis:get(FDFGERB.."FDFGERB:Game:Hgj"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
return LuaTele.sendText(msg_chat_id,msg_id,"*° عذرا مافيه الى ( 6 ) اختيارات بس ارسل اختيارك مره ثانية*\n","md",true)  
end 
local GETNUM = Redis:get(FDFGERB.."FDFGERB:Game:Hgj"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(FDFGERB.."FDFGERB:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(FDFGERB.."FDFGERB:Game:Hgj"..msg.chat_id..msg.sender.user_id)
Redis:incrby(FDFGERB.."FDFGERB:Num:Add:Games"..msg.chat_id..msg.sender.user_id,3)  
...
-- download('https://raw.githubusercontent.com/fawazz77/FDFGERBs/main/FDFGERB.lua','FDFGERB.lua')
...
Redis:del(FDFGERB.."FDFGERB:SendBcBot") 
...
Redis:set(FDFGERB.."FDFGERB:SendBcBot",true) 
...
Redis:del(FDFGERB.."FDFGERB:LeftBot") 
...
{{text =news,url = "https://t.me/V_U_22"}, },}}
...
if not Redis:sismember(FDFGERB.."FDFGERB:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"° مو مالك عشان انزله ").Reply,"md",true)  
else
Redis:srem(FDFGERB.."FDFGERB:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(FDFGERB.."FDFGERB:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"° مو مالك من قبل ").Reply,"md",true)  
else
Redis:srem(FDFGERB.."FDFGERB:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(FDFGERB.."FDFGERB:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"° مو مالك عشان انزله ").Reply,"md",true)  
else
Redis:srem(FDFGERB.."FDFGERB:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(FDFGERB.."FDFGERB:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"° مالك من قبل ").Reply,"md",true)  
else
Redis:sadd(FDFGERB.."FDFGERB:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(FDFGERB.."FDFGERB:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"° مالك من قبل ").Reply,"md",true)  
else
Redis:sadd(FDFGERB.."FDFGERB:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(FDFGERB.."FDFGERB:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"° مالك من قبل ").Reply,"md",true)  
else
Redis:sadd(FDFGERB.."FDFGERB:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
local Info_Members = Redis:smembers(FDFGERB.."FDFGERB:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
if text and text:match("^(.*)$") then
if Redis:get(FDFGERB.."FDFGERB11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(FDFGERB.."FDFGERB11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(FDFGERB.."FDFGERB11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(FDFGERB.."FDFGERB11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(FDFGERB.."FDFGERB11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(FDFGERB..'FDFGERB11:Add:Rd:Sudo:Text'..text)
Redis:del(FDFGERB..'FDFGERB11:Add:Rd:Sudo:Text1'..text)
Redis:del(FDFGERB..'FDFGERB11:Add:Rd:Sudo:Text2'..text)
Redis:del(FDFGERB.."FDFGERB11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(FDFGERB.."FDFGERB11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(FDFGERB.."FDFGERB11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(FDFGERB.."FDFGERB11:Add:Rd:Sudo:Text"..v) 
Redis:del(FDFGERB.."FDFGERB11:Add:Rd:Sudo:Text1"..v) 
Redis:del(FDFGERB.."FDFGERB11:Add:Rd:Sudo:Text2"..v)   
Redis:del(FDFGERB.."FDFGERB11:List:Rd:Sudo")
end
...
Redis:set(FDFGERB.."FDFGERB11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(FDFGERB.."FDFGERB11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(FDFGERB.."FDFGERB11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(FDFGERB.."FDFGERB11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(FDFGERB.."FDFGERB11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(FDFGERB.."FDFGERB11:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = Redis:get(FDFGERB.."FDFGERB11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(FDFGERB.."FDFGERB11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(FDFGERB.."FDFGERB11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(FDFGERB.."FDFGERB11:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = Redis:get(FDFGERB.."FDFGERB11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(FDFGERB.."FDFGERB11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(FDFGERB.."FDFGERB11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(FDFGERB.."FDFGERB11:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = Redis:get(FDFGERB.."FDFGERB11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(FDFGERB.."FDFGERB11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(FDFGERB.."FDFGERB11:Add:Rd:Sudo:Text2"..text)   
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/V_U_22'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n °  عليك الاشتراك في قناة البوت لاستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then
...
if Redis:sismember(FDFGERB.."FDFGERB:ktmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," °  تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(FDFGERB.."FDFGERB:ktmAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(FDFGERB.."FDFGERB:ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(FDFGERB.."FDFGERB:ktmAll:Groups",UserId_Info.id) 
...
if Redis:sismember(FDFGERB.."FDFGERB:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(FDFGERB.."FDFGERB:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(FDFGERB.."FDFGERB:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(FDFGERB.."FDFGERB:ktmAll:Groups",Message_Reply.sender.user_id) 
...
{
{text = 'السورس', url = "https://t.me/V_U_22"}
},
}
...
Redis:set(FDFGERB.."FDFGERB:BotFree"..msg_chat_id,true) 
...
Redis:set(FDFGERB.."FDFGERB:TwaslBot"..msg_chat_id,true) 
...
Redis:del(FDFGERB.."FDFGERB:TwaslBot"..msg_chat_id)  
...
Redis:del(FDFGERB.."FDFGERB:BotFree"..msg_chat_id)  
...
Redis:setex(FDFGERB.."FDFGERB:Set:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
...
Redis:del(FDFGERB.."FDFGERB:Set:Id:Groups")
...
Redis:del(FDFGERB.."FDFGERB:TheBasicsQ:Group"..msg_chat_id) 
...
keyboardd.inline_keyboard = {
{
{text = '𝗖𝗼𝗳𝗳𝗲𝗲', url = "https://t.me/V_U_22"}
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
{
{text = '𝑺𝒐𝒖𝒓𝒄𝒆', url = "https://t.me/V_U_22"},
},
{
{text = '𝑫𝒆𝒗', url = "https://t.me/V_U_22"}
},
}
local msgg = msg_id/2097152/0.5
...
if text == (Redis:get(FDFGERB.."FDFGERB:Name:Bot") or "شهد") then
local NamesBot = (Redis:get(FDFGERB.."FDFGERB:Name:Bot") or "شهد")
local NameBots = {
"الله ياخذ "..NamesBot.."",
"لاتناديني زعلان منك",
"الله يرزقك حياه غير "..NamesBot.."",
"موجود بس لاتزعجني",
"قول شعندك",
"لبيه",
"امرني ياعيوني",
...
Redis:set(FDFGERB.."FDFGERB:Game:Ghj"..msg.chat_id,name)
...
Redis:set(FDFGERB.."FDFGERB:Game:Amt"..msg.chat_id,name)
...
if text == "عواصم" then
if Redis:get(FDFGERB.."FDFGERB:Status:Games"..msg.chat_id) then
Redis:del(FDFGERB.."FDFGERB:Set:Aii"..msg.chat_id)
...
name = katu[math.random(#katu)]
Redis:set(FDFGERB.."FDFGERB:Game:Aii"..msg.chat_id,name)
...
if Redis:get(FDFGERB.."FDFGERB:Status:Games"..msg.chat_id) then
Redis:del(FDFGERB.."FDFGERB:Set:Aig"..msg.chat_id)
...
name = katu[math.random(#katu)]
Redis:set(FDFGERB.."FDFGERB:Game:Aig"..msg.chat_id,name)
...
if Redis:get(FDFGERB.."FDFGERB:Status:Games"..msg.chat_id) then
Redis:del(FDFGERB.."FDFGERB:Set:Ret"..msg.chat_id)
katu = {"95","399","9","119","877","8","55","114","143","144","153","932","211","7","67","515","520","511","509"}
name = katu[math.random(#katu)]
Redis:set(FDFGERB.."FDFGERB:Game:Ret"..msg.chat_id,name)
...
name = katu[math.random(#katu)]
Redis:set(FDFGERB.."FDFGERB:Game:Arg"..msg.chat_id,name)
...
if Redis:get(FDFGERB.."FDFGERB:Status:Games"..msg.chat_id) then
Redis:del(FDFGERB.."FDFGERB:Set:Gii"..msg.chat_id)
...
name = katu[math.random(#katu)]
Redis:set(FDFGERB.."FDFGERB:Game:Gii"..msg.chat_id,name)
...
if Redis:get(FDFGERB.."FDFGERB:Status:Games"..msg.chat_id) then
Num = math.random(1,6)
Redis:set(FDFGERB.."FDFGERB:Game:Hgj"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(FDFGERB.."FDFGERB:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
...
Redis:set(FDFGERB.."FDFGERB:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
...
Redis:set(FDFGERB.."FDFGERB:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
local CmdStart = '*\n° أهلآ بك في بوت '..(Redis:get(FDFGERB.."FDFGERB:Name:Bot") or "شهد")..
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FDFGERB.."FDFGERB:Sasa:Jeka"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FDFGERB.."FDFGERB:TheBasicsQ:Group"..ChatId) 
